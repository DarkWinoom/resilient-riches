...
初始资金是启用时的实际余额，已包含历史盈亏。历史本金优先按“初始资金−历史盈亏”还原；无法还原时，在该分类首次有有效本金的节点计入历史盈亏，再按复利累计。例如初始资金0、历史盈利15,000，转入10,000后余额9,800，累计盈亏14,800、累计收益率148%。无本金的节点暂不显示百分比，图表以0%位置绘制；收益率不设100%上限。
